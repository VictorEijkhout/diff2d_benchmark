...
\makeindex[columns=2,title=General Index of Terms]
\makeindex[name=cpp,columns=2,title=Index of C++ Keywords]
\makeindex[name=f90,columns=2,title=Index of Fortran Keywords]
\makeindex[name=head,columns=2,title=Index of C++ headers]
\makeindex[name=jul]
\makeindex[name=gsl,columns=1,title=List of Core Guidelines]
